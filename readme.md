...
> 本 Fork 已改为使用 ranheliang 仓库地址；“懒人配置-含策略组”默认指向安全优化版 `lazy_group_safe.conf`。
...
**正在使用手机浏览本页面的用户 [请点击这里](https://github.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever) ，查看完整的说明文档。**
...
- 增加使用代理组的懒人配置；
- 由于世界排名 top 500 网站列表已无法通过无账户/免费方式取得，故原来的 top500 检测方法失效。我已根据旧的 top500 榜单重构了新的 top500 网站连接情况表。**同时，希望大家可以帮助 pull requests 一份最新的 top500 榜单: [格式](https://github.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/blob/build/factory/resultant/top500_manual.list)**
- **所有发布的规则都会在每天北京时间 8:00 更新发布**


## 规则列表

![规则选择指南](https://raw.githubusercontent.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/release/figure/guide.png)
...
任何问题欢迎在 [Issues](https://github.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/issues) 中反馈。

你的反馈会让此规则变得更加完美。

**如何贡献代码？**

通常的情况下，对 [factory 目录](https://github.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/tree/build/factory) 下的 3 个 `manual_*.txt` 文件做对应修改即可。**Pull requests 请发送至 build 分支。**
...
规则地址：<https://raw.githubusercontent.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/release/sr_top500_banlist.conf>

![二维码](https://api.qrserver.com/v1/create-qr-code/?size=260x260&data=https%3A%2F%2Fraw.githubusercontent.com%2Franheliang%2FShadowrocket-ADBlock-Rules-Forever%2Frelease%2Fsr_top500_banlist.conf)
...
规则地址：<https://raw.githubusercontent.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/release/sr_top500_whitelist.conf>

![二维码](https://api.qrserver.com/v1/create-qr-code/?size=260x260&data=https%3A%2F%2Fraw.githubusercontent.com%2Franheliang%2FShadowrocket-ADBlock-Rules-Forever%2Frelease%2Fsr_top500_whitelist.conf)
...
规则地址：<https://raw.githubusercontent.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/release/sr_cnip.conf>

![二维码](https://api.qrserver.com/v1/create-qr-code/?size=260x260&data=https%3A%2F%2Fraw.githubusercontent.com%2Franheliang%2FShadowrocket-ADBlock-Rules-Forever%2Frelease%2Fsr_cnip.conf)
...
规则地址：<https://raw.githubusercontent.com/ranheliang/Shadowrocket-ADBlock-Rules-Forever/release/sr_backcn.conf>

![二维码](https://api.qrserver.com/v1/create-qr-code/?size=260x260&data=https%3A%2F%2Fraw.githubusercontent.com%2Franheliang%2FShadowrocket-ADBlock-Rules-Forever%2Frelease%2Fsr_backcn.conf)
...
[![Stargazers over time](https://starchart.cc/ranheliang/Shadowrocket-ADBlock-Rules-Forever.svg)](https://starchart.cc/ranheliang/Shadowrocket-ADBlock-Rules-Forever)
